...
<head>
  ...
  <link rel="stylesheet" crossorigin href="{{ asset('templet/dist/assets/compiled/css/auth.css') }}">
</head>

<body>
    <script src="{{ asset('templet/dist/assets/static/js/initTheme.js') }}"></script>
    <div id="auth">
